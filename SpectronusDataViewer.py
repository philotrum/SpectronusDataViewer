...
class SpectronusData_Dialog(Frame):
    ...
    def openDatabase(self):
        ...
        Ax1.plot(Date,CO2, label='CO2',color='r')
        Ax1.plot(Date,CO2_12, label='12CO2', color='b')
        Ax1.plot(Date,CO2_13, label='13CO2', color='g')
        Ax1.set_ylabel("CO2")
        ...
        Ax2.plot(Date,Del13C, label='Del13C', color='r')
        ...
        Ax2.plot(Date,CellTemp, label='Cell Temp')
        ...
        Ax3.plot(Date,RoomTemp, label='Room Temp')
        ...
        Ax4.plot(Date,FlowIn, label='Flow In',color='r')
        Ax4.plot(Date,FlowOut, label='Flow Out',color='b')
        ...
        Ax5.plot(Date,N2_Tank_Hi, label='N2_Tank_Hi')
        ...
        # Target tank high
        Ax6=Ax5.twinx()
        Ax6.plot(Date, Target_Tank_Hi, label='Target_Tank_Hi', color='r')
